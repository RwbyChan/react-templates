...
var fse = {
    ...
    ensureFile: function (path) { return __awaiter(void 0, void 0, void 0, function () {
        var _a, dir;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0: return [4, fse.exists(path)];
                case 1:
                    _a = (_b.sent());
                    if (!_a) return [3, 3];
                    return [4, fse.stat(path)];
                case 2:
                    _a = (_b.sent()).isFile() === true;
                    _b.label = 3;
                case 3:
                    if (_a) {
                        return [2];
                    ...
                    return [4, mkdirp_1.default(dir)];
                case 4:
                    _b.sent();
                    return [4, fse.writeFile(path, '')];
                case 5:
                    _b.sent();
                    return [2];
            }
